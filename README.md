...
![Snapshot1](https://user-images.githubusercontent.com/89750173/166121357-5ee60d2f-8f49-4de1-8fcc-084561a00ea9.PNG)  

# The bin/Release folder contains assemblies for the most popular operating systems:  
1)WINDOWS:  
    1.x64  
    2.x86  
    3.ARM  
...
# В папке bin/Release находятся сборки для самых популярных ОС:  
1)WINDOWS:  
    1. x64  
    2. x86  
    3. ARM  
